...
public class MoneyInputDB {
   ...
   public static final String SQL_DBname="moneyinput";
   public static final String SQL_Create_Moneybook =
           "create table moneyinput (_id integer primary key autoincrement,"
                   +"content text,"
                   +"memo text,"
   ...
   private static class DBHelper extends SQLiteOpenHelper {
    ...
    public MoneyInputDB(Context cxt, String sql, String tname){
        this.cxt=cxt;
        SQL_Table_Create=sql;
        Table_Name=tname;
    }
    public MoneyInputDB open() throws SQLiteException{
